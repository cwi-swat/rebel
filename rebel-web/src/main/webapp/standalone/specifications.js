var specs = [ 
	{ 
		...
		"fields":[{"name":"totalAmount", "type":"Money"}, 
		          {"name":"debitBookings", "type":"Integer"}, 
		          {"name":"settlementDate", "type":"Date"}, 
		          {"name":"creditBooking", "type":"Integer"}, 
		...
		"events":[{ 
		          ...
		          { 
		          	...
		          	"config": [], 
		           	...
		           	"preconditions": [{"code":"bookingToCancel in this.debitBookings;"},{"code":"bookingToCancel instate initialized;"},{"doc":"To balance this cancellation a new booking on the creditor is created", "code":"DebitCreditorBooking[bookingToBalance].creditor == this.creditor"},{"code":"DebitCreditorBooking[bookingToBalance].amount == DebitBooking[bookingToCancel].amount;"},{"code":"DebitCreditorBooking[bookingToBalance].settlementDate == this.settlementDate;"},{"code":"not bookingToBalance in this.debitBookings;"},{"code":"bookingToBalance instate initialized;"}], 
	...
	{ 
		...
		"inheritsFrom": {"name":"Account", "url":"account.Account"}, 
		"extendedBy":[], 
		"fields":[{"name":"accountNumber", "type":"IBAN"}], 
		"events":[{ 
		...
		"events":[{ 
		          ...
		          { 
		          	...
		          	"config": [], 
		           	...
		           	"postconditions": [], 
		           	"sync": [{"code":"RevolvingWashAccount[1].withdraw(this.amount)"},{"code":"SepaDirectDebitWashAccount[NL34INGB0000001].deposit(this.amount)"}] 
		          	}, 
		          { 
		          	...
		          	"config": [], 
		           	...
		           	"preconditions": [], 
		           	"postconditions": [], 
		           	"sync": [{"code":"BusinessCurrentAccount[this.creditor].forcedWithdraw(this.amount)"},{"code":"RevolvingWashAccount[NL34INGB0000001].deposit(this.amount)"}] 
		          	}, 
		          { 
		          	"id": "event_init_create_initialized", 
		          	"label": "create", 
		          ...
		          { 
		          	...
		          	"config": [], 
		           	...
		           	"postconditions": [], 
		           	"sync": [{"code":"CurrentAccount[this.debtor].withdraw(this.amount)"},{"code":"SepaDirectDebitWashAccount[NL34INGB0000001].deposit(this.amount)"}] 
		          	}, 
		          { 
		          	...
		          	"config": [], 
		           	...
		           	"preconditions": [], 
		           	"postconditions": [], 
		           	"sync": [{"code":"CurrentAccount[this.debtor].forcedWithdraw(this.amount)"},{"code":"RevolvingWashAccount[NL34INGB0000001].deposit(this.amount)"}] 
		          	}, 
		          { 
		          ...
		          { 
		          	...
		          	"config": [], 
		           	...
		           	"preconditions": [], 
		           	"postconditions": [], 
		           	"sync": [{"code":"BusinessCurrentAccount[this.creditor].forcedWithdraw(this.amount)"},{"code":"SepaDirectDebitWashAccount[NL34INGB0000001].deposit(this.amount)"}] 
		          	}, 
		          { 
		          ...
		          { 
		          	...
		          	"config": [], 
		           	...
		           	"postconditions": [], 
		           	"sync": [{"code":"CurrentAccount[this.debtor].withdraw(this.amount)"},{"code":"RevolvingWashAccount[NL34INGB0000001].deposit(this.amount)"}] 
		          	}, 
		          { 
		          	...
		          	"config": [], 
		           	...
		           	"postconditions": [], 
		           	"sync": [{"code":"CurrentAccount[this.debtor].withdraw(this.amount)"},{"code":"SepaDirectDebitWashAccount[NL34INGB0000001].deposit(this.amount)"},{"code":"RevolvingWashAccount[NL34INGB0000001].withdraw(this.amount)"}] 
		          	}, 
		          { 
	...
	{ 
		...
		"states":[{"id":"state_successful", "label":"", "final": true}, 
		...
		"events":[{ 
		          ...
		          { 
		          	...
		          	"config": [], 
		           	...
		           	"preconditions": [], 
		           	"postconditions": [{"code":"new this.orderingAccountt == orderingAccount;"},{"code":"new this.beneficiaryAccount == beneficiaryAccount;"},{"code":"new this.requestedExecutionDate == requestedExecutionDate;"},{"code":"new this.receivedTime == now;"},{"code":"new this.amount == amount;"}], 
		           	"sync": [] 
		          	}, 
		          { 
