...
// Lib tests
public Module testModule = annotate(parseModule("module account.AccountLib
...
public Module creditBookingLib = annotate(parseModule(|project://rebel-core/tests/booking/sepa/dd/CreditBookingLib.ebl|));
...
// Specification tests
public Module creditBooking = annotate(parseModule("module booking.sepa.dd.CreditBooking
